...
from mbed_devices._internal.darwin.system_profiler import (
...
class TestGetAllUSBDevicesData(TestCase):
    @mock.patch("mbed_devices._internal.darwin.system_profiler.subprocess.check_output")
...
@mock.patch("mbed_devices._internal.darwin.system_profiler.get_all_usb_devices_data")
