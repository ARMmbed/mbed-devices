...
from mbed_devices._internal.darwin.diskutil import (
...
class TestGetAllExternalDisksData(TestCase):
    @mock.patch("mbed_devices._internal.darwin.diskutil.subprocess.check_output")
...
class TestGetAllExternalVolumesData(TestCase):
    @mock.patch("mbed_devices._internal.darwin.diskutil.get_all_external_disks_data")
...
class TestGetMountPoint(TestCase):
    @mock.patch("mbed_devices._internal.darwin.diskutil.get_all_external_volumes_data")
