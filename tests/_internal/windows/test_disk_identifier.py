...
class TestDiskUid(unittest.TestCase):
    def test_disk_uid_parsing(self):
        from mbed_devices._internal.windows.disk_drive import Win32DiskIdParser, WindowsUID
    ...
    def test_uid_linking_between_usb_and_disk(self):
        from mbed_devices._internal.windows.usb_device_identifier import UsbIdentifier, WindowsUID
